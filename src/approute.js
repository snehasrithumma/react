...
const urlItems = [
  ...
  { label: "wordle", url: "/wordle" },
  { label: "sudoku", url: "/sudoku" },
  { label: "snake", url: "/snake" },
  { label: "TODO", url: "/withredux" },
  //   { label: "TODO Reducer", url: "/withreducer" },
];
      ...
      <div className="view">
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            <Route
              path="/reducer"
              element={<ProtectedRoute element={<CounterReducer />} />}
            />
            <Route
              path="/messenger"
            ...
            <Route
              path="/redux"
              element={<ProtectedRoute element={<CounterRedux />} />}
            />
            <Route
              path="/lazy"
              element={<ProtectedRoute element={<LazyLoading />} />}
            />
            <Route
              path="/counter"
            ...
            <Route
              path="/data"
              element={<ProtectedRoute element={<DataFetch />} />}
            />
            <Route
              path="/timer"
            ...
            <Route
              path="/calculator"
              element={<ProtectedRoute element={<Mortgage />} />}
            />
            <Route
              path="/autoComplete"
              element={<ProtectedRoute element={<AutoComplete />} />}
            />
            <Route
              path="/wordle"
              element={<ProtectedRoute element={<Wordle />} />}
            />
            <Route
              path="/sudoku"
              element={<ProtectedRoute element={<Sudoku />} />}
            />
            <Route
              path="/snake"
              element={<ProtectedRoute element={<Snake />} />}
            />
            <Route
              path="/withredux"
              element={<ProtectedRoute element={<ReduxTodo />} />}
            />
            <Route
              path="/withreducer"
              element={<ProtectedRoute element={<ReducerTodo />} />}
            />
            <Route
              path="/practice"
